...
urlpatterns = [
    ...
    path('mov-rot-novo/', movrotativos_novo, name='core_movrotativo_novo'),
    path('mov-rot-update/<int:id>/', movrotativos_update, name='core_movrotativo_update'),
    path('mov-rot-delete/<int:id>/', movrotativos_delete, name='core_movrotativo_delete'),
